...
class LPIPS(LossTerm):
    ...
    def __init__(self,perceptual_weight=1.0,perceptual_factor=1.0,perceptual_start_iter=None,perceptual_start_epoch=None,use_dropout=True,eval_mode=True,**kwargs):
        super().__init__(perceptual_weight,perceptual_factor,perceptual_start_iter,perceptual_start_epoch)
    ...
    def load_from_pretrained(self, name="vgg_lpips"):
        ckpt = get_ckpt_path(name, "models/stable_diffusion/modules/lpips")
